          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange(
                    'maxPositionSize',
                    parsePercentage(e.target.value).toString()
                  )
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange('minPositionSize', e.target.value)
                }
                className='w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md 
                         bg-white dark:bg-gray-700 text-gray-900 dark:text-white'
                min='1'
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange('maxOpenPositions', e.target.value)
                }
                className='w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md 
                         bg-white dark:bg-gray-700 text-gray-900 dark:text-white'
                min='1'
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange('sentimentPeriod', e.target.value)
                }
                className='w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md 
                         bg-white dark:bg-gray-700 text-gray-900 dark:text-white'
                min='1'
        ...
        <div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange('paperTradingInitialBalance', e.target.value)
              }
              className='w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md 
                       bg-white dark:bg-gray-700 text-gray-900 dark:text-white'
              min='1000'
