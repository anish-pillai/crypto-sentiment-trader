...
import { Wallet, ExternalLink, Trash2, RefreshCw, Plus } from 'lucide-react';
import toast from 'react-hot-toast';

export const ExchangeBalances: React.FC<{ onAddExchange: () => void }> = ({
  onAddExchange,
}) => {
  const {
    credentials,
                ...
                <div className='space-y-2'>
                  {balance.balances.length > 0 ? (
                    ...
                    <div className='text-sm text-gray-500 dark:text-gray-400'>
                      No balance found. Make sure you have funds in your
                      account.
                    </div>
                  )}
