...
export const SentimentDisplay: React.FC = () => {
  ...
  const getTrendIcon = () => {
    switch (sentimentData.trend) {
      ...
      case 'negative':
        return <TrendingDown className="h-6 w-6 text-red-500 dark:text-red-400" />;
      default:
  ...
  return (
    <div className={`rounded-lg shadow-md p-6 transition-colors duration-200 ${getBackgroundColor()}`}>
